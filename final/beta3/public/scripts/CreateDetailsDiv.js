...
function createControlElement(detailsDiv, url, title, username, waveformURL, previewURL){
	...
	$('<form action="/favsound" method="POST"><button type="submit" name="title" value="' + title + '" class="controlButtons favIco" alt="Fav"><i class="fas fa-star"></i></button></input></form>').appendTo(controlDiv);
