...
function createControlElement(detailsDiv, url, title, username, waveformURL, previewURL){
	...
	$('<form class="controlButtons favIco" action="/favsound" method="POST"><button type="submit" formmethod="post" name="title" value="' + title + '" alt="Fav"><i class="fas fa-star"></i></button></form>').appendTo(controlDiv);
