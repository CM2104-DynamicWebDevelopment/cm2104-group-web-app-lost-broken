...
function createControlElement(detailsDiv){
	...
	$('<form action="/favsound" method="POST"><input type="submit" name="title" value="' + title + '"><button class="controlButtons favIco" alt="Fav"><i class="fas fa-star"></i></button></input></form>').appendTo(controlDiv);
}
