...
function buildFavList(response){
    for (var i = 0; i < response.length; i++) {
        ...
        itemHTML += '<div id="listSoundPlay"><button class="controlButtonsP playIco" onclick="playAudio(response[i].sound)" alt="Play"><i class="fas fa-play"></i></button></div>'
        itemHTML += '<div id="listSoundStop"><button class="controlButtonsP stopIco" onclick="stopAudio(response[i].sound)" alt="Stop"><i class="fas fa-stop"></i></button></div'
        itemHTML += '<div id="listFav"><button class="controlButtonsP favIco" onclick="favAudio()" alt="Fav"><i class="fas fa-star"></i></button></div>'
