...
function buildFavList(response){
    for (var i = 0; i < response.length; i++) {
        ...
        itemHTML += '<div id="listSoundPlay"><button class="controlButtons playIco" onclick="playAudio(response[i].sound)" alt="Play"><i class="fas fa-play"></i></button>'
        itemHTML += '<div id="listSoundStop"><button class="controlButtons stopIco" onclick="stopAudio(response[i].sound)" alt="Stop"><i class="fas fa-stop"></i></button>'
        itemHTML += '<button class="controlButtons favIco" onclick="favAudio()" alt="Fav"><i class="fas fa-star"></i></button>'
